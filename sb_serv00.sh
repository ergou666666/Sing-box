...
USERNAME=$(whoami)
HOSTNAME=$(hostname)
export UUID=${UUID:-'1d69f696-3659-a216-3097-7fc663d28668'}
...
tuic://$UUID:Hacker-min@$IP:$tuic_port?sni=www.bing.com&congestion_control=bbr&udp_relay_mode=native&alpn=h3&allow_insecure=1#$ISP
EOF
cat list.txt
